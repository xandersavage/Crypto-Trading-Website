...
exports.showModal = exports.showEmailModal = exports.showAlert = exports.hideAlert = void 0;
...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  hideAlert();
  var markup = "<div class=\"alert alert-".concat(type, " d-flex align-items-center\" role=\"alert\">\n    <svg class=\"bi flex-shrink-0 me-2\" width=\"24\" height=\"24\">\n        <use xlink:href=\"#check-circle-fill\" />\n    </svg>\n    <div>\n        ").concat(msg, "\n    </div>\n</div>");
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          if (_context.t0.response && _context.t0.response.status === 403) {
            errorMessage = encodeURIComponent(_context.t0.response.data.error);
            location.assign("/error?message=".concat(errorMessage));
          } else {
            (0, _alerts.showAlert)("danger", "Incorrect email or password");
          }
        case 11:
        case "end":
          return _context.stop();
...
var addNewTrader = exports.addNewTrader = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(name, winRate, profitShare) {
    var res;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('danger', "error adding trader: ".concat(_context4.t0));
        case 10:
        case "end":
  ...
  return function addNewTrader(_x10, _x11, _x12) {
...
if (newTraderButton) {
  newTraderButton.addEventListener('click', function (e) {
    ...
    (0, _trader.addNewTrader)(name, winRate, profitShare);
  });
}
},{"./signup":"signup.js","./login":"login.js","./admin-update":"admin-update.js","./trader":"trader.js","./email":"email.js","./prices.js":"prices.js","./news.js":"news.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
