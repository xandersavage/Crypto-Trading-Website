    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.status === 200) {
            (0, _alerts.showEmailModal)('Emails sent successfully');
          }
          _context.next = 10;
          break;
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showEmailModal)("Error sending email ".concat(_context.t0));
        case 10:
        case "end":
          return _context.stop();
      }
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          return _context.abrupt("return", newsList.map(function (news) {
            var description = news.description.split('. ')[0] + '.';
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          res = _context.sent;
          if (res.status === 200) {
            (0, _alerts.showWithdrawalEmailModal)('Withdrawal successful!');
            window.setTimeout(function () {
              location.reload(true);
            }, 2000);
          }
        ...
        case 7:
          _context.prev = 7;
          _context.t0 = _context["catch"](0);
          (0, _alerts.showWithdrawalEmailModal)("Error: ".concat(_context.t0.response.data.error));
        case 10:
        case "end":
          return _context.stop();
      }
...
},{"./signup":"signup.js","./login":"login.js","./admin-update":"admin-update.js","./trader":"trader.js","./email":"email.js","./prices.js":"prices.js","./news.js":"news.js","./alerts":"alerts.js","./withdraw.js":"withdraw.js"}],"../../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
